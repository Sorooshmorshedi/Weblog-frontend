<template>
  <v-card
    class="indigo lighten-1 overflow-hidden ma-5 "
    color=#59886B
    dark
  >
    <v-toolbar
    ...
    >
      ...
      <v-toolbar-title class="font-weight-light" colo>
        Profile Setting
      </v-toolbar-title>
    </v-toolbar>
...
export default {
  ...
  methods: {
    ...
    editAcc() {
      ...
      this.$axios.$put('http://127.0.0.1:8000/api/account/'+this.$route.params.slug+'/', this.data)
        .then(response => {
