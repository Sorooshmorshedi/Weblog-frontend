<template>
  <div>
    <v-container fluid v-for="pin in newpins">
      ...
      <v-row justify="center">
        ...
        >
          ...
          <v-card class="purple lighten-3  ma-3 pa-1">
            <h2>
              <v-avatar
                color="purple"
                size="35"
    ...
    <v-alert
      outlined
      class="justify-center align-center ma-6 pa-6"
      type="success"
      text
    >
      you are all caught up ! you seen all pins from here
    </v-alert>

    <v-container fluid v-for="pin in oldpins">
...
export default {
  async asyncData({$axios}) {
    const items = await $axios.$get(`http://127.0.0.1:8000/api/pin`)
    console.log(items)
    return {items}
  },
